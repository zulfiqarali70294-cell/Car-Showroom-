...
public class OldSportsCar6 extends Application{
	...
	public void start(Stage primaryStage) throws Exception {
		...
		Text car1 = new Text("Car Name :		   	     Mustange brochure"
				+ "\n Car Model : 		   	 1968"
				+ "\n Year of Manifacture :	 1968"
				+ " \n Varient : 			     Sports "
				+ "\n Color : 					White"
				+ "\n HPower : 				769"
		...
		stage.setTitle("Sports Car old 6 Details");

...
public class RentAcar1 extends Application{
	...
	public void start(Stage primaryStage) throws Exception {
		...
		Text car1 = new Text("Car Name :		INDUS COROLLA"
				+ "\n Car Model : 		   	 2002"
				+ "\n Year of Manifacture :	 2001"
				+ " \n Varient : 			    EE  100"
				+ "\n Color : 					White"
				+ "\n HPower : 				60"
				+ "\n Engine Capacity : 	    1300cc"
				+ "\n  Avrage : 				15km"
				+ "\n  Price Per Hour : 		5000Rs");
		...
		stage.setTitle("Rent Car1 Details");

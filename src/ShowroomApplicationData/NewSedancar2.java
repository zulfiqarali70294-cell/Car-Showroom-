...
public class NewSedancar2 extends Application{
	...
	public void start(Stage primaryStage) throws Exception {
		...
		Text car1 = new Text("Car Name :			Toyota Grande X"
				+ "\n Car Model : 		   	   2022"
				+ "\n Year of Manifacture :	   2021"
				+ " \n Varient : 			  X CVT-i"
				+ "\n Color : 					White"
				+ "\n HPower : 				180"
		...
		stage.setTitle("Sedan Car New 2 Details");

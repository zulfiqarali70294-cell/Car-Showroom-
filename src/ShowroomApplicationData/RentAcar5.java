...
public class RentAcar5 extends Application{
	...
	public void start(Stage primaryStage) throws Exception {
		...
		Text car1 = new Text("Car Name :	  KIDS LAMBORGENI"
				+ "\n Car Model : 		   	 2023"
				+ "\n Year of Manifacture :	 2023"
				+ " \n Varient : 			  kid  300"
				+ "\n Color : 					WHITE"
				+ "\n HPower : 				60"
				+ "\n Engine Capacity : 	    Battery Operated"
				+ "\n  Avrage : 				10km"
				+ "\n  Price Per Hour : 		500Rs");
		...
		stage.setTitle("Rent Car5 Details");

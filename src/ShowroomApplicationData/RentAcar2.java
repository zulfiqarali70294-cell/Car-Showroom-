...
public class RentAcar2 extends Application{
	...
	public void start(Stage primaryStage) throws Exception {
		...
		Text car1 = new Text("Car Name :		SUZUKI AULTO"
				+ "\n Car Model : 		   	 2022"
				+ "\n Year of Manifacture :	 2022"
				+ " \n Varient : 			  VX  L"
				+ "\n Color : 					White"
				+ "\n HPower : 				60"
				+ "\n Engine Capacity : 	    660cc"
				+ "\n  Avrage : 				24km"
				+ "\n  Price Per Hour : 		3000Rs");
		...
		stage.setTitle("Rent Car2 Details");

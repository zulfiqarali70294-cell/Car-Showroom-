...
public class OldSportsCar2 extends Application{
	...
	public void start(Stage primaryStage) throws Exception {
		...
		Text car1 = new Text("Car Name :		   	     Plymouth Barracuda"
				+ "\n Car Model : 		   	 1970"
				+ "\n Year of Manifacture :	 1970"
				+ " \n Varient : 			     Sports "
				+ "\n Color : 					Red"
				+ "\n HPower : 				335"
				+ "\n Engine Capacity : 	    4000cc"
				+ "\n  Avrage : 				7km"
				+ "\n  Price : 				60000000Rs");
		...
		stage.setTitle("Sports Car old 2 Details");
